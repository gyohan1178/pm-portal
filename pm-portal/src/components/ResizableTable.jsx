 ...
 */
export function ResizableTable({ cols, storageKey, children, stickyHeader = true, sortKey, sortDir, onSort }) {
                ...
                {cols.map(c => (
                  <th key={c.key}
                    ...
                    <span
                      ...
                      className={onSort && c.sortable !== false ? 'cursor-pointer select-none hover:text-slate-600' : ''}>
